...
import com.samchi.poke.kanghwi.presentation.ui.KanghwiAsyncImage
...
import com.samchi.poke.kanghwi.presentation.ui.getBackgroundColor
import com.samchi.poke.kanghwi.presentation.ui.rememberPaletteState
    ...
    Card(
        ...
        Column(
            ...
            Text(
                ...
                text = pokemon.name,
                color = KanghwiPokeTddTheme.colors.dark,
                style = TextStyle(
